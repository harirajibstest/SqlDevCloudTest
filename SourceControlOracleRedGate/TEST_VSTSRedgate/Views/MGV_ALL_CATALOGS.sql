CREATE OR REPLACE FORCE VIEW "TEST_VSTSRedgate".mgv_all_catalogs (project_id,project_name,connection_id,host,port,username,dburl,catalog_id,catalog_name) AS
