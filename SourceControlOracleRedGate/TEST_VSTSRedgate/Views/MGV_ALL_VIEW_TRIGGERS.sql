CREATE OR REPLACE FORCE VIEW "TEST_VSTSRedgate".mgv_all_view_triggers (project_id,project_name,connection_id,host,port,username,catalog_id,catalog_name,dummy_flag,schema_id,schema_name,view_id,view_name,trigger_id,trigger_name) AS
