CREATE OR REPLACE FORCE VIEW "TEST_VSTSRedgate".outstandingcontracts (categorycd,contractno,vendor,quantity,price,contractdate,paymentterm,bank,contractvalue,outstandingamount) AS
select
...
To_Char(Conr_Reference_Date,'dd-mm-yy') As "CONTRACTDATE",
 Pkgreturncursor.Fncgetdescription(Conr_Payment_Terms,2) As "PAYMENTTERM",
  conr_local_bank as "BANK",      
