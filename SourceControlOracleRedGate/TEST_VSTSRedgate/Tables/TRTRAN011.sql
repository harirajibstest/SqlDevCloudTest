CREATE TABLE "TEST_VSTSRedgate".trtran011 (
  rdel_company_code NUMBER(8) NOT NULL,
  rdel_risk_reference VARCHAR2(25 BYTE) NOT NULL,
  ...
  rdel_limit_usd NUMBER(20,6),
  rdel_amount_excess NUMBER(20,6),
  ...
  rdel_message_text VARCHAR2(4000 BYTE),
